...
<svg class="dgm" viewBox="0 0 900 320" role="img" xmlns="http://www.w3.org/2000/svg" aria-label="Cap enforcement: with $30 already pulled against a $50 per-period cap, a $35 pull exceeds the $20 remaining, so the program returns AmountExceedsPeriodLimit (400) and the whole transaction reverts.">
<defs>
  ...
  <text x="450" y="240" text-anchor="middle" class="t">AmountExceedsPeriodLimit (400) — the transaction reverts</text>
